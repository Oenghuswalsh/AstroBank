...
<body>
    ...
    <div class="breadcrumbs">
        <a href="./index.php">AstroBank/</a><a href="./accounts.php">Accounts/</a>
    </div>
    ...
    <div class="newsCardSection">
        <div class="bankingCardSection">
            <div class="paraCards">
                ...
                <?php if (isset($user)) : ?>
                    <a href="./myastrobank.php" class="linkButton">Apply for a savings account today</a>
                <?php else : ?>
    ...
    <div class="newsCardSection">
        <div class="bankingCardSection">
            ...
            <div class="paraCards">
                ...
                <a href="./creditcards.php" class="linkButton">Apply for a Credit Card today</a>
            </div>
        </div>
    </div>
    <div class="bankingCardSection">
        <div class="bankingCards">
            <h2>Home Loans</h2>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quasi alias quo repellendus nesciunt. Porro, soluta?</p>
            <a href="./homeloans.php" class="linkButton">Apply</a>
        </div>
        <div class="bankingCards">
