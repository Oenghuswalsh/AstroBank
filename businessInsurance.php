...
<body>
    <header>
        ...
        <nav class="desktops">
            <div id="navMenu" class="button-container"> <!-- Navigation buttons in header -->
                ...
                <button class="button selected" id="insurance-button">Insurance</button>
    ...
    <div class="breadcrumbs">
        <a href="./index.php">AstroBank/</a><a href="./businessInsurance.php">Business Insurance/</a>
    </div>
    ...
    <div class="newsCardSection">
        <div class="bankingCardSection">
            ...
            <div class="newsCards">
                <img class="cardImage" src="./Images/Business_insurance.jpg" alt="High rise building in a city">
            </div>
        </div>
    </div>
    <div class="bankingCardSection">
